...
#define TRANSMISSION_TEXTURE_INDEX 5
#define RCOAT_TEXTURE_INDEX 6
#define COAT_ROUGHNESS_TEXTURE_INDEX 7
#define COAT_NORMAL_TEXTURE_INDEX 8
#define PBR_TEXTURE_COUNT COAT_NORMAL_TEXTURE_INDEX + 1
